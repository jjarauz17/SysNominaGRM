Public Class frmCat_Produccion_Detalle 
    ...
    Private Sub frmCat_Produccion_Detalle_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            det = Cat_ProdDB.Detalles(EmpresaActual, ID, True)
    ...
    Private Sub Calcular()
        Dim i As Decimal
        i = Math.Round(Me.cat_valor.EditValue / IIf(Me.cat_dias.EditValue = 0, dias, Me.cat_dias.EditValue), 4)
        Me.cat_salarioxdia.EditValue = Math.Round(Me.cat_valor.EditValue / IIf(Me.cat_dias.EditValue = 0, dias, Me.cat_dias.EditValue), 4)
