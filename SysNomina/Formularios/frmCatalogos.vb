            ...
            If Not Tabla Is Nothing Then
                If Tabla.TableName = "Detalle" Then
                    ...
                    Try
                        ...
                        pgCatalogo.Fields.Add("Forma Pago", DevExpress.XtraPivotGrid.PivotArea.FilterArea)
                        pgCatalogo.Fields("Forma Pago").FieldName = "Forma Pago"
                        pgCatalogo.Fields("Forma Pago").Caption = "Forma Pago"
