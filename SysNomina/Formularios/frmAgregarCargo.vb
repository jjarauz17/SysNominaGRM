Public Class frmAgregarCargo
    ...
    Private Shared ChildInstance As frmAgregarCargo = Nothing

    Public Shared Function Instance() As frmAgregarCargo
        If ChildInstance Is Nothing OrElse ChildInstance.IsDisposed = True Then
            ChildInstance = New frmAgregarCargo()
        End If
...
#End Region
    ...
    Private Sub cmdAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdAceptar.Click
        If Trim(txtCodigo.Text) = "" Then
            MsgBox("Introduzca el Código del Cargo", MsgBoxStyle.Information)
            txtCodigo.Focus()
            txtCodigo.SelectAll()
            Exit Sub
        ...
        If Trim(txtNombre.Text) = "" Then
            MsgBox("Introduzca el Nombre del Cargo", MsgBoxStyle.Information)
            txtNombre.Focus()
            txtNombre.SelectAll()
            Exit Sub
        ...
        If Nuevo = "SI" Then
            Try
                VB.SysContab.CargosDB.Additem(txtCodigo.Text, txtNombre.Text)
        ...
        Else
            VB.SysContab.CargosDB.Update(Registro, txtNombre.Text)
            Me.Close()
    ...
    Private Sub frmAgregarCargo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        If Nuevo = "NO" Then
            Me.Text = "Editar Cargos"
            txtCodigo.ReadOnly = True
            Dim Detalles As VB.SysContab.CargosDetails = VB.SysContab.CargosDB.GetDetails(Registro)
            Me.txtCodigo.Text = Detalles.Codigo
            Me.txtNombre.Text = Detalles.Nombre
            Me.txtNombre.Focus()

        Else
            Me.Text = "Agregar Cargos"
            Me.txtCodigo.Text = VB.SysContab.CargosDB.GetListNuevo
            Me.txtNombre.Text = ""
