        ...
        Public Function FormatGenerico(ByVal Grilla As DataGrid, ByVal fuente As DataTable) As Boolean
            ...
            While i < fuente.Columns.Count
                If fuente.Columns(i).Caption <> "." Then
                    ...
                    If column.MappingName = "No. Entrada" Or column.MappingName = "No. Devolución" Or column.MappingName = "No. Salida" Or column.MappingName.ToUpper = "RUC" Or column.MappingName.ToUpper = "FAX" Then
                        column.Width = 100
                    End If
