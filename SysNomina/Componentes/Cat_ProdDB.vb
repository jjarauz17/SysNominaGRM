...
Public Class Cat_ProdDB
    '1) 
    Public Shared Function Detalles(ByVal Empresa As Integer, ByVal Codigo As Integer, Grid As Boolean) As Cat_Prod_Details
        ...
        v.AddParameter("grid", SqlDbType.Bit, 5, ParameterDirection.Input, Grid)
