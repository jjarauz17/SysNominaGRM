...
Partial Public Class RptDetalleColillaI
    ...
    Private Sub InitializeComponent()
        ...
        Me.TotalI = New DevExpress.XtraReports.UI.XRLabel
        ...
        'ReportFooter
        '
        Me.ReportFooter.Controls.AddRange(New DevExpress.XtraReports.UI.XRControl() {Me.XrLabel1, Me.TotalI})
        ...
        'TotalI
        '
        Me.TotalI.Borders = DevExpress.XtraPrinting.BorderSide.Top
        Me.TotalI.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "mov_valor")})
        Me.TotalI.Font = New System.Drawing.Font("Arial", 7.0!)
        Me.TotalI.LocationFloat = New DevExpress.Utils.PointFloat(125.0!, 0.0!)
        Me.TotalI.Name = "TotalI"
        Me.TotalI.Padding = New DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100.0!)
        Me.TotalI.SizeF = New System.Drawing.SizeF(58.0!, 17.0!)
        XrSummary1.FormatString = "{0:c2}"
        XrSummary1.Running = DevExpress.XtraReports.UI.SummaryRunning.Report
        Me.TotalI.Summary = XrSummary1
        Me.TotalI.Text = "0.00"
        Me.TotalI.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight
        '
        'TopMarginBand1
        '
    ...
    Public WithEvents TotalI As DevExpress.XtraReports.UI.XRLabel
